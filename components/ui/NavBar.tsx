...
<header
    className="flex items-center w-full bg-white dark:bg-dark fixed"
   >
      ...
      <div className="relative flex items-center justify-between -mx-4">
         ...
         <div className="flex items-center justify-between w-full px-4">
            <div>
               ...
               <nav
                  className="absolute right-4 md:hidden top-full w-full max-w-[250px] rounded-lg bg-white py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:shadow-none dark:bg-dark-2 lg:dark:bg-transparent"
                  >
